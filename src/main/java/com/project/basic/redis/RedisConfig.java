...
//        
//        jedisPoolConfig.setMaxTotal(redis.getMaxActive());
//        jedisPoolConfig.setBlockWhenExhausted(redis.isBlockWhenExhausted());
//        jedisPoolConfig.setTestOnBorrow(redis.isTestOnBorrow());
//        jedisPoolConfig.setTestOnReturn(redis.isTestOnReturn());
//        jedisPoolConfig.setLifo(redis.isLifo());//true:后进先出;false:先进先出
//        
